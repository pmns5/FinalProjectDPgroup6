...
CREATE TABLE cast(
  ...
  CONSTRAINT FK_film_cast FOREIGN KEY (film) REFERENCES film(id_film) on update cascade on delete cascade,
  CONSTRAINT FK_actor_feedback FOREIGN KEY (actor) REFERENCES actor(id_actor) on update cascade on delete cascade
);